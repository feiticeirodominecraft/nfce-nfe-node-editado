...
const getEntregaRetirada_1 = require("./getEntregaRetirada");
function gerarNFe({ documento, geral }) {
    const dadosChave = (0, gerar_chave_nfe_1.gerarChaveNF)(documento.emit.CNPJ, {
        ...
        dhEmi: (0, utils_2.hasValue)(documento.ide.dhEmi) ? documento.ide.dhEmi : (0, utils_1.getDataAtual)(),
        mod: geral.modelo,
        serie: documento.ide.serie,
        nNF: documento.ide.nNF,
        tpEmis: (geral.isContingencia ?? false) ? '6' : documento.ide.tpEmis
    });
    /*const nfe = {
        ...
        dest: (0, getDest_1.getDest)(geral.ambiente, documento.dest),
        entrega: (0, getEntregaRetirada_1.getEntregaRetirada)(documento.entrega),
        retirada: (0, getEntregaRetirada_1.getEntregaRetirada)(documento.retirada),
    ...
    const nfe = (0, getIde_1.getIde)(geral, documento.ide, dadosChave).mod === "65" ? {
        $: { versao: '4.00', Id: `NFe${dadosChave.chave}` },
        ide: (0, getIde_1.getIde)(geral, documento.ide, dadosChave),
        emit: (0, getEmit_1.getEmit)(documento.emit),
        dest: (0, getDest_1.getDest)(geral.ambiente, documento.dest),
